									...
									<div class="col-sm-12">
                                        ...
                                        <table id="dataTableExample1" class="table table-bordered table-hover">
											...
											<?php 
													...
													$comp_qry=mysql_query("SELECT * FROM  tbl_Nairabank  order by id asc");
											...
											while($data=mysql_fetch_array($comp_qry))
											{
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="edit-nairabankdetails.php?id=<?php echo $data["id"];?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        </td>
                                                </tr>
											<?php $i++;} 
											}
